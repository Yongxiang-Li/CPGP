...
%-  Minus.
%
%   C - D subtracts matrices C and D. C and D must have the same
%   dimensions unless one is a scalar. A scalar can be subtracted 
%   from anything.
%
%   A = MINUS(C,D) is called for the syntax 'C - D' when C or D
%   is a smcirc matrix. The result is a smcirc matrix only when
