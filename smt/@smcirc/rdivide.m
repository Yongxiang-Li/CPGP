...
%
%   A = RDIVIDE(C,D) is called for the syntax 'C ./ D' when C
%   or D is a smcirc object. The result is a smcirc matrix only
...
%
%   See also SMCIRC/LDIVIDE, SMCIRC/MRDIVIDE, SMCIRC/MLDIVIDE.
