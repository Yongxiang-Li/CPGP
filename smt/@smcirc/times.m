...
%.*  Array multiply.
%
%   C.*D denotes element-by-element multiplication. C and D
%   must have the same dimensions unless one is a scalar.
%   A scalar can be multiplied into anything.
%
%   A = TIMES(C,D) is called for the syntax 'C .* D' when C or
%   D is an smcirc object. The result is a smcirc matrix only
