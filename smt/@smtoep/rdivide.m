function T = rdivide(T,S)
%./  Right array divide.
%
%   T./S denotes element-by-element division. T and S must
%   have the same dimensions unless one is a scalar.
%   A scalar can be divided with anything.
%
%   A = RDIVIDE(T,S) is called for the syntax 'T ./ S' when T
%   or S is a smtoep object. The result is a smtoep matrix only
...
%
%   See also SMTOEP/LDIVIDE, SMTOEP/MRDIVIDE, SMTOEP/MLDIVIDE.
