function T = minus(T,S)
%-  Minus.
%
%   T - S subtracts matrices T and S. T and S must have the same
%   dimensions unless one is a scalar. A scalar can be subtracted 
%   from anything.
%
%   A = MINUS(T,S) is called for the syntax 'T - S' when T or S
%   is a smtoep matrix. The result is a smtoep matrix only when
